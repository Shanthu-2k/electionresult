...
public class Tables {
    public static final String DB_NAME="SHANTHIPRIYA.DB";
    ...
    public static final String CREATE_TABLE=" create table " + TABLE_NAME + " ( " + ID + " INTEGER PRIMARY KEY AUTOINCREMENT , " + NAME + " TEXT NOT NULL , " + PRICE + " TEXT NOT NULL , " + QUANTITY + " TEXT NOT NULL , " + CATEGORY + " TEXT NOT NULL , " + CONTACT + " TEXT NOT NULL , " + DESC + " TEXT NOT NULL , " + IMAGE + " TEXT NOT NULL ) ; ";
